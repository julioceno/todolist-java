...
import br.com.julioceno.todolist.Utils.Utils;
...
public class TaskController {
    ...
    @PutMapping("/{id}")
    public TaskModel updateTask(@PathVariable UUID id, @RequestBody TaskModel taskModel, HttpServletRequest request) {
        taskModel.setId(id);
